        ...
        <div>
            ...
            <div className="container">
                <div className="row default-padding">
                    <div className="col-sm-6">
                        ...
                        <p className=" font-17 pb-4">REI Litics offers an intuitive and easy-to-use dashboard to help you quickly compare data on the top metro markets across the U.S.</p>
                        <p className='font-17 pb-4'>Imagine the time you&#39;ll save and the advantage you&#39;ll have with information on pricing, appreciation, rental returns, property taxes, demand, and other economic and demographic factors instantly available at your fingertips.</p>
                        <p className='font-17 pb-4'>Our mission is simple - To create the most versatile market research platform available for real estate investors.  </p>
                    </div>
            ...
            <div id='Prices' className="container mt-3">
                <div className="row default-padding">
                    ...
                    <p className=" font-17 my-4">Pick the plan that works best for your needs. No contracts or long-term agreements. Use REI Litics as long as it&#39;s helpful to you and your goals.</p>
                    <PriceCard />
                </div>
