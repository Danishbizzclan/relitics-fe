...
export default function EditNotes() {
    ...
    const eventId = router.query.slug ? router.query.slug[0] : '';
                    ...
                    <div className="d-inline-flex w-100">
                        ...
                        <div style={{ width: "inherit" }}>
                            ...
                            <div className='container mx-auto py-3'>
                                ...
                                <p className='fs-30 Gothic_3D my-3'>{event.city}</p>
                                <div className='p-5 card'>
                                    <p className='fs-22 Bold greyBlack my-3'>Notes</p>
                                    <p className='fs-22 Bolder my-4'>{event.title}</p>
                                    <p className='fs-16'>{event.details}</p>
