    ...
    return (
        <div className="mx-auto text-center py-5 px-3 w-100 Card-color ">
            ...
            <div className="text-center w-75 price-border div-color edge px-4  mx-auto">
                ...
                <p className="mt-2 fs-22 Gothic_3D text-nowrap mb-0">{props.Packages}</p>
                ...
                <p className="my-auto  ms-2 fs-14" >{props.Tags[0]}</p>
                </div>
                <div className="d-flex mb-4">
                    <img src={"check-circle-fill.png"} className="img-fluid" style={{ objectFit: "contain" }} alt="..." />
                    <p className="my-auto ms-2 fs-14" >{props.Tags[1]}</p>
                </div>
                <div className="d-flex mb-4">
                    <img src={"check-circle-fill.png"} className="img-fluid" style={{ objectFit: "contain" }} alt="..." />
                    <p className="my-auto ms-2 fs-14" >{props.Tags[2]}</p>
                </div>
                <div className="d-flex mb-4 mb-4">
                    <img src={"check-circle-fill.png"} className="img-fluid" style={{ objectFit: "contain" }} alt="..." />
                    <p className="my-auto ms-2 fs-14">{props.Tags[3]}</p>
                </div>
            </div>
