...
const HomeFeature = [
    {
        id: 1,
        img:
            <svg xmlns="http://www.w3.org/2000/svg" width="74.28" height="69.722" viewBox="0 0 74.28 69.722">
        ...
        Feature: "Quick Overviews",
        Deatail: "Get a bird’s eye view of all the statistics and metrics of top metro markets across the country.",
        ...
        img:
            <svg xmlns="http://www.w3.org/2000/svg" width="77.404" height="69.683" viewBox="0 0 77.404 69.683">
                <g id="Group_234" data-name="Group 234" transform="translate(1 1)">
                    <path id="Path_237" data-name="Path 237" d="M357.947,450.334a34.418,34.418,0,1,1,43.132-33.3M386.356,398.12l-16.561,16.557m-6.423.906-12.813-7.4" transform="translate(-332.245 -382.619)" fill="none" stroke="#0064a2" strokeMiterlimit="10" strokeWidth="2" />
                    ...
                    <path id="Path_239" data-name="Path 239" d="M361.3,385.532v2.419m-26.145,23.724h2.422m64.808-9.064-5.915,12.428-8.539-10.8M361.3,434.334v2.422" transform="translate(-326.887 -377.261)" fill="none" stroke="#0064a2" strokeMiterlimit="10" strokeWidth="2" />
                </g>
            </svg>,
        Feature: "Less Research",
        Deatail: "Stay on top of the latest trends in top metro markets across the country so you can invest where it makes most sense to you.  ",
